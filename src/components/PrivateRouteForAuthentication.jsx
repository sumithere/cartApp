...
function PrivateRouteForAuthentication({children,...props}){
    ...
    //   (props)=>{
          return (currentUser!=null?<Navigate to="/"></Navigate>:children)
    //   }
    // } ></Route>)
...
const mapStateToProps=(state)=>{
  ...
  export default connect(mapStateToProps)(PrivateRouteForAuthentication);
